                    ...
                    <div class="col-md-10">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <input type="text" class="form-control" id="dev-table-filter" data-action="filter" data-filters="#dev-table" placeholder="Filter Numéro" />
                            </div>
                            <table class="table table-hover" id="dev-table">
                                ...
                                <c:forEach var = "list" items = "${lists}">
                                    <tr class="first">
                                        ...
                                        <td>${list.type}</td>
                                        <td>${list.operateur}</td>
                                        <td>${list.regle_tarifiaire}</td>


                                        <td>
                                            <div class="btn-group" role="group" aria-label="...">

                                                <a href="/deletenum/${list.numero_id}"> <button type="button"><i class="glyphicon glyphicon-trash">
                                                </i></button></a>
                                                <a href="/edit/${list.numero_id}"><button type="button"><i class="glyphicon glyphicon-pencil">
                                                </i></button></a>
                            ...
                            <div class="panel-body">
                                <form method="post" action="/saveee">
                                    <input type="hidden" name="numero_id" value=""/>
                                    <b>Ajouter Numéro:</b><br><br>
                                    <div class="col-xs-2">
                                    ...
                                    <input type="text" name="operateur"placeholder="Opérateur"class="form-control"/>
                                    </div>
                                    <div class="col-xs-2">

                                    <input type="text" name="regle_tarifiaire"placeholder="Règle Tarifiaire"class="form-control"/>
                                    </div>
