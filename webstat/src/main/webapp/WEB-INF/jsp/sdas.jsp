                        ...
                        <div class="col-md-10">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title">SDAs</h3>
                                </div>
                                <div class="panel-body">
                                    <input type="text" class="form-control" id="dev-table-filter" data-action="filter" data-filters="#dev-table" placeholder="Filter SDAs" />
                                </div>
                                        ...
                                        <tr class="first">
                                            ...
                                            <td>
                                                <div class="btn-group" role="group" aria-label="...">
                                                    ...
                                                    <a href="/deletesda/${list.sda_id}"> <button type="button"><i class="glyphicon glyphicon-trash">
                                                    </i></button></a>
                                                    <a href="/editsda/${list.sda_id}"><button type="button"><i class="glyphicon glyphicon-pencil">
                                                    </i></button></a>
                                ...
                                <div class="panel-body">
                                    <form method="post" action="/savee">
                                        <input type="hidden" name="sda_id" value=""/>
                                        <b>Ajouter SDA:</b><br><br>
                                        <div class="col-xs-2">
                                            <input type="text" name="sda" placeholder="SDA" class="form-control"/>
                                        </div>
                                        <div class="col-xs-3">

                                        <input type="text" name="oper_sda"placeholder="Opérateur SDA" class="form-control"/>
                                        </div>
                                        ...
                                        <input type="text" name="oper_num"placeholder="Opérateur Numéro"class="form-control"/>
                                        </div>

                                        <select name="num_sda" class="selectpicker show-tick">
